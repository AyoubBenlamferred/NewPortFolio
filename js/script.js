...
// ============================================
// CURSEUR NEON FUTURISTE PLUS RAPIDE
// ============================================
...
function initNeonCursor() {
  ...
  // VITESSE AUGMENTÉE
  // Avant : outerSpeed = 0.1 et innerSpeed = 0.3
  // Maintenant : curseur beaucoup plus réactif
  const outerSpeed = 0.35;
  const innerSpeed = 0.75;
